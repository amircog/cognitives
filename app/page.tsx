...
import { Beaker, Brain, BrainCog, BarChart2, FlaskConical, Shapes, Target, Search, Users, Type, Lock, LockOpen, Timer, GitFork } from 'lucide-react';
...
const CATEGORIES = [
  ...
  { name: 'DECISION MAKING',   nameHe: 'קבלת החלטות',  ids: ['twoStepTask'] },
